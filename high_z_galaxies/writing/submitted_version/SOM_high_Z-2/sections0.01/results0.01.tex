...
\label{sec: result}
    ...
    %%% should I move this paragraph to method section?! %%PB20160510: I think it's OK here.
    ...
    We created the final SOMs with following initial values: number of iterations in ordering phase = 1000; ordering phase learning factor = 0.9; tuning phase learning factor= 0.02; and tuning phase neighbourhood distance to be 1. %PB20160510: if you're going to use "=" here, put the symbol too, ie $N=1000$ iterations for the ordering phase, ordering phase learning factor $L_0=0.9$, etc
    ...
    \label{sec: 1D}
        ...
        \label{sec: 1Dt}
            ...
            As it was mentioned in the Sec.~\ref{sec: method}, the colours between neurons represents the relative distance, $D_j$, between the neurons and the darker is the colour the more $D_j$ is between them. %PB20160510: I think I would use "relaive distance" rather than the second $D_j$
            ...
            In the upper map in Fig.~\ref{fig: 1by2T}, the dark colour between two neurons indicates that the $D_j$ between these two groups are relatively high, and these two groups are distinguishable groups. %PB20160510: same here, use "relative distance" rather than $D_j$.
            ...
            While the white colour shows the two neurons are very similar to one another. %PB20160510: the two *right* neurons (?)
            ...
            The high amount of extinction causes SED become more flat in the lower wavelength regions. %PB20160510: I would say "at shorter wavelengths" rather than "in the lower wavelength region"
        ...
        \end{figure*} %PB160427: this figure looks really great! Very easy to understand.
           ...
           %PB20160510: I think the above is a general observation about clustering, not just SOM. I suggest pointing it out at the end, not here.
        \subsubsection{ CLASSIFYING SAMPLE OF GALAXIES}
         \label{sec: 1Dv}
            ...
            Increasing the size of the SOM helps to solve the problem of the galaxies which have features of both groups.
             ...
             These groups of galaxies have strong emission lines and the ascending slope towards the lower wavelengths, but they also have a strong 4000\AA~break, which makes them to move towards the early type galaxies (middle plot in the lower part of Fig.~\ref{fig: 1by2V}). %PB20160510: "rising flux towards the ultraviolet" rather than "the ascending slope towards the lower wavelengths"
        ...
        In all the plots $x$-axis shows the number of the neurons divided by the size of the network, and $y$-axis shows one of the mentioned properties. %PB20160510:  use horizontal and vertical rather than $x$ and $y$.
        ...
        They, however, studied other relations between properties of a sample of SINGS galaxies which didn't have a direct correlation in the models. %PB20160510: you that mean the properties didn't have a direct correlation in the models, not that the galaxies didn't have a direct correlation, right? 
    ...
    \end{figure*}
        ...
        However, this value and position is very similar to N09 results. %PB20160510: I think you need to talk about this a bit more. Why are the S0s out of line with everything else?
        Otherwise, considering the morphology of the galaxies, early type galaxies have more A$_{\rm {FUV}}$.
        Therefore, we could conclude that the classification of the SED of galaxies using SOM, separates galaxies based on their morphological type and the characteristic of each of these groups are in agreement with the general picture of the galaxy evolution. %PB20160510: but you don't have morphological types for your galaxies (or do you?) I think what you are concluding is that separating galaxies based on SED types also leads to a separation in properties derived (via CIGALE) from the SEDs, which you'd expect.
    ...
    As described in the Sec.~\ref{sec: method}, one of the main advantages of the SOM is that when the weight of one neuron is adjusted after finding the BMU, the weight of the whole map will be changed. %PB20160510: spell out BMU - reader has probably forgotten by now.
    ...
    In the upper left part of the map in Fig.~\ref{fig: 12by12}, there is a strip of the grey, dark grey and in some cases black colour is distinguishable. %PB20160510: not really the right sentence to start a paragraph with. Same for next paragraph.
    ...
    In both lower maps in Fig.~\ref{fig: 12by12}, most the galaxies are in the early type side of the SOM, which was predictable from the results in the Sec.\ref{sec: 1Dv}. %PB20160510: could also talk about this as it relates to the method used to select the galaxies in the first place (once you find out what that was!)
