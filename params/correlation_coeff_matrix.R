...
#small_m31=m31[c(1,6,8,10),]
#small_m31_1=small_m31[c(4:ncol(m31))]
#small_m31_2=small_m31_1[-1]
#small_m31_1=small_m31_2[-4]
small_m31_1= m31[c(4:ncol(m31))]
x_cor=cor(small_m31_1, use='pairwise',method="pearson")
res1 <- cor.mtest(x_cor, 0.95)
res2 <- cor.mtest(x_cor, 0.99)
corrplot(x_cor, method = "color", addrect = 3,tl.cex = 0.8,tl.col='black')#, insig = "blank",p.mat = res1[[1]],sig.level = 0.05)
dev.off()