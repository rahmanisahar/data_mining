...
%     This tool is designed to show the distance between each cluster more clearly.
     Specifically, we use two of the plots in this tool: a hits map, which shows the number of times each neuron has won (hits), and a distance map, which shows the distance between those neurons. %PB20160603: number of times it has won *what* ?
